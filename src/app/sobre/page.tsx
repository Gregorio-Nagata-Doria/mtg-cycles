...
export default function About() {
  ...
  return (
    <div className="mx-auto flex max-w-measure flex-col gap-5 px-6 pt-10 pb-9 sm:gap-6 sm:px-8 sm:pt-16 sm:pb-18">
      <Ornament rule="w-11 sm:w-16" />

      <h1 className="text-center font-serif display-2 font-bold">
      ...
      <figure className="flex flex-col gap-2 sm:gap-4">
        ...
        <figcaption className="text-center text-meta text-muted">
      ...
      <p className="text-body leading-[1.65] text-pretty text-secondary sm:leading-[1.75] sm:text-secondary-body">
        <T
          pt={
            <>
